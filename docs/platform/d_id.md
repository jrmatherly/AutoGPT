...
1. **ElevenLabs**
   ...
   - Copy the voice_id
   - Use it as a string in the voice_id field in the CreateTalkingAvatarVideoBlock
...
2. **Microsoft Azure Voices**
    ...
    - Use this string en-GB-AbbiNeural in the voice_id field in the CreateTalkingAvatarVideoBlock
...
3. **Amazon Polly Voices**
    ...
    - Use it as string in the voice_id field in the CreateTalkingAvatarVideoBlock